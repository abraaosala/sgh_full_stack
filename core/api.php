...
Route::group(['prefix' => '/api', 'middleware' => []], function () {
    ...
    Route::get('/consultas/paciente', "App\Controllers\Patient\PcConsultaController::api");
   ...
   Route::get('consult/med-paciente', "App\Controllers\Medical\MedPasController::api");
    ...
    //Api do Paciente
    Route::get('/consulta/pac-listar','App\Controllers\Patient\PcConsultaController::list' )
    ->middleware(AuthMiddleware::class)
    ->middleware(PacienteMiddleware::class)
    ;
    Route::get('/consulta/paciente/all', 'App\Controllers\Patient\PcConsultaController::apiAll');
    Route::post('/consulta-paciente/store', 'App\Controllers\Patient\PcConsultaController::store');

    Route::post('/emitir-ficha', 'App\Controllers\Patient\PcConsultaController::print');
