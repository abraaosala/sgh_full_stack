<div class="pc-container">
    <div class="pc-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="<?php echo root(); ?>pacientes"> <i class="feather icon-users"></i>
                                        Gerenciar Paciente</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
        ...
        <div class="card shadow-lg border-0 col-sm-12 col-md-8 offset-md-2 mt-5 rounded-2">
            <form action="<?php echo lnk("admin/paciente-save"); ?>" method="post" autocomplete="off"
                ...
                <div class="card-header bg-gradient text-white text-center py-4 rounded-top"
                    ...
                    <h4 class="mb-0"><i class="feather icon-user-plus me-2"></i> Alterar Paciente </h4>
                ...
                <div class="card-body px-4 py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <?php ?>
                        <?php include iViewForm('user-paciente') ?>
                    </div>
