<div class="pc-container">
    <div class="pc-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-2">
                                <li class="breadcrumb-item">
                                    <a href="<?php echo root(); ?>admin/dashboard"><i class="feather icon-home"></i> Painel Hospitalar</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="<?php echo root(); ?>admin/users"> <i class="feather icon-users"></i> Gerenciar Usuários</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
        ...
        <div class="card shadow-lg border-0 col-sm-12 col-md-8 offset-md-2 mt-5 rounded-2">
            <form action="<?php echo root(); ?>admin/usuario-salvar" method="post" autocomplete="off" class="needs-validation" novalidate>
