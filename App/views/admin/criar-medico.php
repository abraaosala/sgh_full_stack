<div class="pc-container">
    <div class="pc-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-2">
                                <li class="breadcrumb-item">
                                    <a href="<?= lnk('dashboard') ?>"><i class="feather icon-home"></i> Painel Hospitalar</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="<?= lnk('admin/medicos') ?>"> <i class="feather icon-users"></i> </a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
        ...
        <div class="card shadow-lg border-0 col-sm-12 col-md-8 offset-md-2 mt-5 rounded-2">
            <form action="<?= lnk('admin/medico-store') ?>" method="post" autocomplete="off" class="needs-validation" novalidate>
                <div class="card-header bg-gradient text-white text-center py-4 rounded-top" style="background: linear-gradient(45deg, #4e73df, #224abe);">
                    <h4 class="mb-0"><i class="feather icon-user-plus me-2"></i> Cadastro de Novo Medico</h4>
                    <p class="small">Preencha os campos abaixo para registrar um novo utilizador</p>
                </div>

                <div class="card-body px-4 py-4">
                    <?php echo flash('error'); ?>
                    <?php include iViewForm('user-medico') ?>
                </div>
