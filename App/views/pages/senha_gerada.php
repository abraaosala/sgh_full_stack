<div class="pc-container">
    <div class="pc-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-2">
                                <li class="breadcrumb-item">
                                    <a href="<?php echo root(); ?>/"><i class="feather icon-home"></i> Painel Hospitalar</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="<?php echo root(); ?>setting"> <i class="feather icon-config"></i> Configuração</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <i class="feather icon-user-plus"></i> Renovar Senha
                                </li>
                            </ol>
                        </nav>
        ...
        <div class="card shadow-lg border-0 col-sm-12 col-md-8 offset-md-2 mt-5 rounded-2">
            <form action="<?php echo root(); ?>config/salvar-senha" method="post" autocomplete="off" class="needs-validation" novalidate>
               <!--  <div class="card-header bg-gradient text-white text-center py-4 rounded-top" style="background: linear-gradient(45deg, #4e73df, #224abe);">
                    <h4 class="mb-0"><i class="feather icon-user-plus me-2"></i> Cadastro de Novo Usuário</h4>
                    <p class="small">Preencha os campos abaixo para registrar um novo utilizador</p>
                </div> -->

                <div class="card-body px-4 py-4">
                    <?php echo flash(['informar','error']); ?>
                   ...
                   <!--  <div class="mb-4">
                     ...
                     <div class="mt-4">
                       ...
                       <!--  </div> -->
                            ...
                            <div class="mb-3">
                                <label for="confirm_password" class="form-label">Confirmar Senha</label> <span style="color: red; "">*</span> <?=flashMessage('confirm_password')?></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="feather icon-lock"></i></span>
